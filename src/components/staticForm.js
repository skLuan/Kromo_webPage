...
const form = () => {
  ...
  const form = `<form
    class="mt-5 mb-0 contact-block__form"
    id="cf"
    name="cf"
  ...
  >
    <div class="form-row">
      ...
      <input
        id="cf-proyecto"
        name="cf-proyecto"
        value="Caminos del Saman"
        class="col-12 col-sm-6 contact-block__input-text form-control required d-none"
        placeholder="Asunto"
        type="text"
      />
      ...
      <div class="mb-4 col-12">
        <div class="form-group">
          ...
          <textarea
            ...
            class="contact-block__input-textarea form-control required"
            rows="7"
          ></textarea>
          </div>
          <div class="g-recaptcha" data-sitekey="6LdXy5keAAAAAGwy6BUKmEIgpLgGHdf3W8MFHu7E"></div>
<div id="g-recaptcha-error"></div>
      ...
      <div class="col-mb-6">
        <label for="terms"
          >¿Acepta y Autoriza a Kromo Constructores el envio de Información?
        </label>
        <br />
        ...
        <div class="mt-3 d-flex flex-column contact-block__text">
          <a href="http://kromo.com.co/PPD.pdf"
            >POLÍTICA DE PROTECCIÓN DE DATOS</a
          >
          <a href="http://kromo.com.co/PGI.pdf"
            >POLÍTICA DE PROTECCIÓN DE GESTIÓN INTEGRAL</a
          >
        </div>
      </div>
      ...
      <div class="text-center col-12 text-lg-left">
        <button
          class="mt-0 mb-5 contact-block__submit"
          type="submit"
          id="cf-submit"
          name="cf-submit"
        >
  ...
  const capcha = element.querySelector(".g-recaptcha");
  capcha.setAttribute("data-callback", `verifyCaptcha`);
  console.log(capcha.attributes);
