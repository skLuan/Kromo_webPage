const form = () => {
    ...
    const form = `<form class="mt-5 mb-0 contact-block__form" id="cf" name="cf" action="include/sendemail.php" method="post"
        ...
        <div class="form-row">
            ...
            <input id="cf-proyecto" name="cf-proyecto" value="Caminos del Saman"
                class="col-12 col-sm-6 contact-block__input-text form-control required d-none" placeholder="Asunto"
                type="text" />
            ...
            <div class="col-mb-6">
                <label for="terms">¿Acepta y Autoriza a Kromo Constructores el envio de
                    Información?
                </label>
                <br />
            ...
            <div class="text-center col-12 text-lg-left">
                <button class="mt-0 mb-5 contact-block__submit" type="submit" id="cf-submit" name="cf-submit">Enviar
                    mensaje</button>
            </div>
